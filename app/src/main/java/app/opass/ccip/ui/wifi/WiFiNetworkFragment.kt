...
class WiFiNetworkFragment: DialogFragment() {

    private val args: WiFiNetworkFragmentArgs by navArgs()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val recyclerView = RecyclerView(requireContext()).apply {
            ...
            adapter = WifiNetworkAdapter(args.wifiNetworkInfo.toList()) { info ->
                onWifiSelected(info)
                dialog?.dismiss()
            }
        }
